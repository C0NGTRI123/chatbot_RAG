...
from app.src.model import OpenAIGenerator
from app.src.schemas.general_config import ModelCode
...
{target_lang}:"""
    ...
    translation = OpenAIGenerator(prompt, system_message=system_message, model_name=ModelCode.OPENAI_API).generate()
...
Output only the suggestions and nothing else."""
    ...
    reflection = OpenAIGenerator(prompt, system_message=system_message, model_name=ModelCode.OPENAI_API).generate()
    return reflection
...
Output only the new translation and nothing else."""
    ...
    translation_2 = OpenAIGenerator(prompt, system_message=system_message, model_name=ModelCode.OPENAI_API).generate()
